...
const Register = () => {
  ...
  return (
    <div className={registerStyles.mainContainer}>
      <div className={registerStyles.homeLink}>
        {" "}
        Go <a href="/">Home</a>
      </div>
      ...
      {Object.keys(formErrors).length === 0 && isSubmit ? (
        <p>Succesfully registered {teamName}</p>
      ) : (
        ""
      )}
        ...
        <div className={registerStyles.formSection}>
          ...
          <div className={registerStyles.fieldSection}>
            <div className={registerStyles.selectField}>
              <label>number of hackers</label>
              <br />
              <div
                className={registerStyles.selectFieldCurrent}
                tabIndex="1"
                name="numberhackers"
                onChange={(e) => {
                  setNumberHackers(e.target.value);
                  handleChange(e);
                }}
              >
                <div className={registerStyles.selectFieldValue}>
                  <input
                    className={registerStyles.selectFieldInput}
                    type="radio"
                    id="0"
                    value={1}
                    name="numberhackers"
                ...
                <img
                  className={registerStyles.selectFieldIcon}
                  src={DropDown}
                  alt={DropDown}
                  aria-hidden="true"
                />
              ...
              <ul className={registerStyles.selectFieldList}>
                <li>
                  <label
                    className={registerStyles.selectFieldOption}
                    htmlFor="0"
                    aria-hidden="true"
                  >
                    solo
            ...
            <div className={registerStyles.emailfieldSection}>
              ...
              {!numberHackers < 1 ? (
                <button type="submit">
                  Register <strong>{teamName}</strong>
                </button>
              ) : (
                ""
              )}
